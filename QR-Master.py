...
BackColor.sort()
Danger = "WARNING: If the background is not default the QR-Code will not be able to get decoded afterwards" + """
because of the missing transparency"""
def encode():
    ...
    for i in ForeColor:
        print(i)
    ModuleColor = input("Enter Texture color:\n>> ")
    ...
    print(Fore.GREEN)
    print(Fore.LIGHTMAGENTA_EX + "Background colors:" )
    print(Fore.RED + Danger + Fore.RESET + Fore.LIGHTMAGENTA_EX)
    for i in BackColor:
        print(i)
    print("for transparent default background press ENTER")
    ...
    if BackgroundColor == BackColor[0]:
        ...
        print(Fore.RED + Style.BRIGHT + "unknown color" + "\n" + Style.RESET_ALL + Fore.LIGHTGREEN_EX + "selecting Default:'white'[transparent]" + Fore.RESET)
